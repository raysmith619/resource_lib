# wx_tk_rpc.py  24Oct2024  crs  from wx_rpc_.py 
#               30Aug2024  crs  from examples/rpc.py 
# rpc.py        27Aug2024  from https://github.com/TarasZhere/RPC

""" 
Modified to execute server calls from tk master in order
to ensure execution of tkinter function from main thread
"""
import json
import socket
import inspect
    ...
    def __handle__(self, client:socket.socket, address:tuple):
        ...
        while True:
            ...
            try:
                ...
                ret = bg.call(self._methods[functionName], *args, **kwargs)
                response = ret
